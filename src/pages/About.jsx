          ...
          >
            ...
            <div className="w-11/12 mx-auto p-6  lg:w-2/3 lg:h-[26rem] lg:p-12 bg-[#fff] shadow-xl rounded-xl">
              ...
              <p className="font-SFproLight text-md lg:text-xl mb-3 ">
                ...
                teaching newbies in tech through my platform on social media,
                and have fun while at it. In my spare time, I play volleyball,
                draw, watch anime, read, eat good food and hang out with my
                friends.
              </p>
              <Link
                smooth
